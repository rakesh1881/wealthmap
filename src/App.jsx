// ============================================================
// WEALTHMAP v33 — Logo replaced with Rakesh's Finance brand image
// Changes vs v16:
...
const STORAGE_KEY  = "wealthmap_v33";

const LOGO_IMG = "data:image/png;base64,";
    ...
    <div style={{minHeight:"100vh",background:"linear-gradient(135deg,#1E1B4B,#312E81,#4C1D95)",display:"flex",alignItems:"center",justifyContent:"center",padding:16}}>
      <div style={{background:"#fff",borderRadius:24,padding:36,width:"100%",maxWidth:400,boxShadow:"0 32px 80px rgba(0,0,0,0.3)"}}>
        <div style={{textAlign:"center",marginBottom:32}}>
          <img src={LOGO_IMG} alt="Rakesh's Finance" style={{height:90,width:"auto",objectFit:"contain",margin:"0 auto 12px",display:"block"}} />
          <p style={{margin:"4px 0 0",color:"#64748B",fontSize:13}}>Your personal finance tracker</p>
        </div>
        ...
        <div key={cat.id} style={{marginBottom:24}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:10}}>
            ...
            <span style={{flex:1,textAlign:"right",fontSize:14,fontWeight:800,color:(()=>{
              const t = cat.accounts.reduce((sum,acc)=>sum+toINR(calcBalance(acc.id,transactions,accounts,tradeBalanceEffects),acc.currency||"INR",fxRates),0);
              return t>=0?"#0F172A":"#EF4444";
            })()}}>
              {fmtINR(cat.accounts.reduce((sum,acc)=>sum+toINR(calcBalance(acc.id,transactions,accounts,tradeBalanceEffects),acc.currency||"INR",fxRates),0))}
            </span>
            {catEditMode[cat.id] ? (
              <button onClick={()=>setCatEditMode(p=>({...p,[cat.id]:false}))}
                style={{fontSize:12,padding:"3px 10px",borderRadius:7,border:"1.5px solid #A7F3D0",background:"#F0FDF4",color:"#065F46",cursor:"pointer",fontFamily:"inherit",fontWeight:700,whiteSpace:"nowrap"}}>✓ Done</button>
            ) : (
              <button onClick={()=>setCatEditMode(p=>({...p,[cat.id]:true}))}
                style={{fontSize:12,padding:"3px 10px",borderRadius:7,border:"1.5px solid #E2E8F0",background:"#F8FAFC",color:"#475569",cursor:"pointer",fontFamily:"inherit",fontWeight:600,whiteSpace:"nowrap"}}>✏️ Edit</button>
            )}
          </div>
          {/* Compact 2-col grid */}
...
export default function App() {
  ...
  if (authLoading) return (
    <div style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",background:"#F8FAFC"}}>
      <div style={{textAlign:"center"}}>
        <img src={LOGO_IMG} alt="Rakesh's Finance" style={{height:70,width:"auto",objectFit:"contain",margin:"0 auto 12px",display:"block"}} />
      ...
      <div style={{background:"#fff",borderBottom:"1px solid #E2E8F0",position:"sticky",top:0,zIndex:100}}>
        <div style={{maxWidth:960,margin:"0 auto",padding:"0 14px",display:"flex",justifyContent:"space-between",alignItems:"center",height:54}}>
          <div style={{display:"flex",alignItems:"center",gap:8}}>
            <img src={LOGO_IMG} alt="Rakesh's Finance" style={{height:38,width:"auto",objectFit:"contain"}} />
          </div>
          <div style={{display:"flex",alignItems:"center",gap:8}}>
