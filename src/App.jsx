// ============================================================
// WEALTHMAP v76 — Brokerage deducted from source account on buy (added to sell credit reduction)
// Changes vs v16:
...
const STORAGE_KEY  = "wealthmap_v76";
...
function AccountModal({ state, onClose, onSave, editAcc }) {
  ...
  function save(ccOverrides={}) {
    ...
    const base = {
      ...
      includeInNetWorth:inclNW, include_in_networth:inclNW, include_in_networth:inclNW, disabled:false,
    };
    if (isEdit) {
